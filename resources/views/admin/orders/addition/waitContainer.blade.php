<div>
    @if (count($waitContainerStocks) === 0)
    ...
    @else
        <table class="table table-striped">
            ...
            @foreach ($waitContainerStocks as $stock)
                <tr>
                    <td>
                    ...
                    <td>
                        <form method="POST" action="{{ url('/admin/orders/addition/addContainer') }}">
                            @csrf

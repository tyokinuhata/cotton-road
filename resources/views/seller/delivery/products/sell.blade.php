...
@section('content')
    <div class="container">
        <h1 class="h1 mb-3">商品出品</h1>
        <div class="mb-2">
            <form method="POST" action="{{ url('/seller/delivery/products/sell') }}" class="d-inline">
                @csrf
                <div>
                    <div class="row mb-2">
                ...
                <div>
                    <div class="row mb-2">
                        ...
                        <input type="number" id="amount" name="amount" class="form-control col-md-7 d-inline" value="1" min="1" max="1000" required>
                    </div>
